...
import { BlockTabs, ContentTabs, Content1, Content2, Content3, TitleJob, WorkWrapper, WorkContainer, Heading, TextWrapper, Button, Divider, Img, ImgWrap, Location, TitleWrap, DescriptionWrap, Description, ListItem, Date } from "./WorkElements";
...
function Work() {
  ...
  return (
    ...
    <BlockTabs>
        <Button onClick={() => toggleTab(1)}>Music Unbounded</Button>
        <Divider />
        <Button onClick={() => toggleTab(2)}>Amazon</Button>
        <Divider />
        <Button onClick={() => toggleTab(3)}>Tutor</Button>
      </BlockTabs>
